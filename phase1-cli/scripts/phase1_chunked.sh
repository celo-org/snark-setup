...
for i in $(seq 0 $(($MAX_CHUNK_INDEX/2))); do
  ...
  yes | $phase1_1 --chunk-index $i contribute --challenge-fname challenge_$i --current-accumulator-hash-fname challenge_$i.hash --response-fname response_$i --contribution-hash-fname response_$i.hash
  ...
  yes | $phase1_2 --chunk-index $i contribute --challenge-fname new_challenge_$i --current-accumulator-hash-fname new_challenge_$i.hash --response-fname new_response_$i --contribution-hash-fname new_response_$i.hash
...
for i in $(seq $(($MAX_CHUNK_INDEX/2 + 1)) $MAX_CHUNK_INDEX); do
  $phase1_1 --chunk-index $i new --challenge-fname challenge_$i
  yes | $phase1_2 --chunk-index $i contribute --challenge-fname challenge_$i --current-accumulator-hash-fname challenge_$i.hash --response-fname response_$i --contribution-hash-fname response_$i.hash
  check_hash challenge_$i
  check_hash response_$i
  $phase1_1 --chunk-index $i verify-and-transform-pok-and-correctness --challenge-fname challenge_$i --response-fname response_$i --new-challenge-fname new_challenge_$i
  yes | $phase1_1 --chunk-index $i contribute --challenge-fname new_challenge_$i --current-accumulator-hash-fname new_challenge_$i.hash --response-fname new_response_$i --contribution-hash-fname new_response_$i.hash
  check_hash new_challenge_$i
  check_hash new_response_$i
  $phase1_2 --chunk-index $i verify-and-transform-pok-and-correctness --challenge-fname new_challenge_$i --response-fname new_response_$i --new-challenge-fname new_new_challenge_$i
  rm challenge_$i new_challenge_$i new_new_challenge_$i # no longer needed
...
for i in $(seq 0 $(($MAX_CHUNK_INDEX/2))); do
  yes | $phase1_1 --chunk-index $i contribute --challenge-fname chunk_split_$i --current-accumulator-hash-fname chunk_split_$i.hash --response-fname response_split_$i --contribution-hash-fname response_split_$i.hash
  ...
  yes | $phase1_2 --chunk-index $i contribute --challenge-fname new_challenge_split_$i --current-accumulator-hash-fname new_challenge_split_$i.hash  --response-fname new_response_split_$i --contribution-hash-fname new_response_split_$i.hash
...
for i in $(seq $(($MAX_CHUNK_INDEX/2 + 1)) $MAX_CHUNK_INDEX); do
  yes | $phase1_2 --chunk-index $i contribute --challenge-fname chunk_split_$i --current-accumulator-hash-fname chunk_split_$i.hash --response-fname response_split_$i --contribution-hash-fname response_split_$i.hash
  check_hash chunk_split_$i
  check_hash response_split_$i
  ...
  yes | $phase1_1 --chunk-index $i contribute --challenge-fname new_challenge_split_$i --current-accumulator-hash-fname new_challenge_split_$i.hash --response-fname new_response_split_$i --contribution-hash-fname new_response_split_$i.hash
  check_hash new_challenge_split_$i
  check_hash new_response_split_$i
...
$phase1_full beacon --challenge-fname combined_split --current-accumulator-hash-fname challenge_$i.hash --response-fname response_beacon_split --contribution-hash-fname response_$i.hash --beacon-hash 0000000000000000000a558a61ddc8ee4e488d647a747fe4dcc362fe2026c620
