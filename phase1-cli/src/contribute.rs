...
pub fn contribute<T: Engine + Sync>(
    ...
    current_accumulator_hash_filename: &str,
    response_filename: &str,
    contribution_hash_filename: &str,
...

    {
        ...
        std::fs::File::create(current_accumulator_hash_filename)
    ...
    std::fs::File::create(contribution_hash_filename)
