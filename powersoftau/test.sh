...
cargo run --release --bin powersoftau -- --batch-size $BATCH --power $SIZE verify-and-transform --challenge-fname challenge2 --response-fname response2 --new-challenge-fname challenge3
...
cargo run --release --bin powersoftau -- --batch-size $BATCH --power $SIZE verify-and-transform --challenge-fname challenge3 --response-fname response3 --new-challenge-fname challenge4
...
cargo run --release --bin powersoftau -- --batch-size $BATCH --power $SIZE verify-and-transform --challenge-fname challenge4 --response-fname response4 --new-challenge-fname challenge5